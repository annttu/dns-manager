...
urlpatterns = patterns('',
    ...
    url(r'^domains/add_static/(?P<domain>[a-zA-Z0-9\.\-]+)$', "manager.views.add_static", name="add_static"),
    url(r'^domains/edit_static/(?P<domain>[a-zA-Z0-9\.\-]+)/(?P<entry>\d+)$', "manager.views.edit_static", name="edit_static"),
    url(r'^domains/delete_static/(?P<domain>[a-zA-Z0-9\.\-]+)/(?P<entry>\d+)$', "manager.views.delete_static", name="delete_static"),
    url(r'^domains/sync/(?P<domain>[a-zA-Z0-9\.\-]+)?$', "manager.views.synchronize_domain", name="synchronize_domain"),
